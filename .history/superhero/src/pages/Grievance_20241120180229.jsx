        ...
        <>
            ...
            <div className="relative h-screen bg-cover bg-center flex justify-center items-center" style={{ backgroundImage: "url('https://wallpapercave.com/wp/420IWNk.jpg')" }}>
                ...
                <div className="relative z-10 bg-transparent bg-opacity-20 backdrop-blur-lg p-6 rounded-lg shadow-lg w-full max-w-lg mx-4">
                    <h2 className="text-2xl font-bold text-white text-center mb-6">Grievance Form</h2>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full text-black p-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-red-500"
                                required
                            />
                        </div>
                        <div>
                            ...
                            <input
                                ...
                                className="w-full p-2 text-black rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-red-500"
                                required
                            />
                        </div>
                        <div>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-white mb-1">Problem Description</label>
                            <textarea
                ...
                {showPopup && (
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                        <div className="bg-white p-6 rounded-lg shadow-lg text-black text-center space-y-4">
